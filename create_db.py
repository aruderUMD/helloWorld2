...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'aruder', 'email': 'aruder@umd.edu', 'first_name': 'Adam', 'last_name': 'Ruder',
         'password': generate_password_hash('aruder', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Adam','email': 'aruder@umd.edu', 'last_name': 'Ruder', 'major_id':3,
         'birth_date': dt.strptime('2004-01-01', '%Y-%m-%d'), 'is_honors': 1}
    ]

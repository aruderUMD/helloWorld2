...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'email': 'rsmith@umd.edu', 'last_name':'Smith', 'major_id':3,
            'birth_date': dt.datetime(2007, 6, 1), 'is_honors':1},
        {'student_id': '2', 'first_name': 'Leo','email': 'lvanmunching@umd.edu', 'last_name': 'Van Munching', 'major_id':6,
